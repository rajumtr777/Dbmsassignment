...
<body>
    ...
    <div class="ts-main-content" style="background-color:lightblue;">
							...
							<div class="col-md-8 col-md-offset-2" >
								...
								<form action="" class="mt" method="post">
									...
									<input type="password" placeholder="Password" name="password" class="form-control mb">
                                                                        ...
                                                                        <input style="background-color:lightblue;color: black;"type="submit" name="login" class="btn btn-primary btn-block" value="login" >
								</form>
							</div>
						</div>
